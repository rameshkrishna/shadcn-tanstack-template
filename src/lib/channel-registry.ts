...
export const ETSY_FIELD_SCHEMA: Array<FieldSchema> = [
  ...
  { key: "shippingProfile", label: "Shipping profile", type: "text", required: true, placeholder: "e.g. Made to order (must match an existing shop processing profile exactly)" },
  { key: "tags", label: "Tags (up to 13)", type: "tags", required: false },
  { key: "materials", label: "Materials (up to 5)", type: "tags", required: false },
